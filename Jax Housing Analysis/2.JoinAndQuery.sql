...
SELECT  
		...
		/* Common table query */
		landuse_1, zoning_1, unit_type_1, IFNULL(units_1,0.0) AS units_1, IFNULL(land_val_1,0) AS land_val_1,
		landuse_2, zoning_2, unit_type_2, IFNULL(units_2,0.0) AS units_2, IFNULL(land_val_2,0) AS land_val_2,
		landuse_3, zoning_3, unit_type_3, IFNULL(units_3,0.0) AS units_3, IFNULL(land_val_3,0) AS land_val_3,
		landuse_4, zoning_4, unit_type_4, IFNULL(units_4,0.0) AS units_4, IFNULL(land_val_4,0) AS land_val_4,
		landuse_5, zoning_5, unit_type_5, IFNULL(units_5,0.0) AS units_5, IFNULL(land_val_5,0) AS land_val_5,
		landuse_6, zoning_6, unit_type_6, IFNULL(units_6,0.0) AS units_6, IFNULL(land_val_6,0) AS land_val_6,
		landuse_7, zoning_7, unit_type_7, IFNULL(units_7,0.0) AS units_7, IFNULL(land_val_7,0) AS land_val_7,
		landuse_8, zoning_8, unit_type_8, IFNULL(units_8,0.0) AS units_8, IFNULL(land_val_8,0) AS land_val_8,
		landuse_9, zoning_9, unit_type_9, IFNULL(units_9,0.0) AS units_9, IFNULL(land_val_9,0) AS land_val_9,
		landuse_10, zoning_10, unit_type_10, IFNULL(units_10,0.0) AS units_10, IFNULL(land_val_10,0) AS land_val_10,
		/* Sales table query */
		trans_id, status, reason, sale_date, seller_1, seller_2, improved, IFNULL(price,0) AS price,
		/* Feature table query */
		feat1, IFNULL(feat1_grade,0.0) AS feat1_grade,
		...
		feat2, IFNULL(feat2_grade,0.0) AS feat2_grade,
		...
		feat3, IFNULL(feat3_grade,0.0) AS feat3_grade,
		...
		feat4, IFNULL(feat4_grade,0.0) AS feat4_grade,
		...
		feat5, IFNULL(feat5_grade,0.0) AS feat5_grade,
		...
		feat6, IFNULL(feat6_grade,0.0) AS feat6_grade,
		...
		feat7, IFNULL(feat7_grade,0.0) AS feat7_grade,
		...
		feat8, IFNULL(feat8_grade,0.0) AS feat8_grade,
		...
		feat9, IFNULL(feat9_grade,0.0) AS feat9_grade,
		...
		feat10, IFNULL(feat10_grade,0.0) AS feat10_grade,
		...
		feat11, IFNULL(feat11_grade,0.0) AS feat11_grade,
		...
		feat12, IFNULL(feat12_grade,0.0) AS feat12_grade,
		...
		feat13, IFNULL(feat13_grade,0.0) AS feat13_grade,
		...
		feat14, IFNULL(feat14_grade,0.0) AS feat14_grade,
		...
		feat15, IFNULL(feat15_grade,0.0) AS feat15_grade,
		...
		feat16, IFNULL(feat16_grade,0.0) AS feat16_grade,
		...
		feat17, IFNULL(feat17_grade,0.0) AS feat17_grade,
		...
		feat18, IFNULL(feat18_grade,0.0) AS feat18_grade,
		...
		feat19, IFNULL(feat19_grade,0.0) AS feat19_grade,
		...
		feat20, IFNULL(feat20_grade,0.0) AS feat20_grade,
		...
		feat21, IFNULL(feat21_grade,0.0) AS feat21_grade,
		...
		feat22, IFNULL(feat22_grade,0.0) AS feat22_grade,
		...
		feat23, IFNULL(feat23_grade,0.0) AS feat23_grade,
